...
const Header = () => {
  ...
  return (
    <motion.header
      className={`sticky top-0 z-50 w-full transition-all duration-500 border-b border-primary/10 ${
        scrolled
          ? "bg-background/90 backdrop-blur-2xl shadow-sm dark:bg-background/90"
          : "bg-background/70 backdrop-blur-lg dark:bg-background/70"
      }`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      <div className="container flex h-20 items-center px-4 sm:px-6 lg:px-8">
        ...
        <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
          ...
          <SheetContent side="left" className="w-[300px] sm:w-[400px]">
             <div className="flex flex-col h-full"> {/* Wrapping content inside sheet content */}
