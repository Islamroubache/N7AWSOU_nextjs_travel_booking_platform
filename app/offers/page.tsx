  ...
  const recommendedOffers = useMemo(() => {
    ...
    let recs = offers
      .filter(offer => 
        ...
        offer.price >= 30000 && offer.price <= 150000 // Price range
      )
          ...
          <div className="col-span-1">
            <div className="relative">
              ...
              >
                ...
                <option value="0-100000">Under 100,000 DA</option>
                <option value="100000-200000">100,000 DA - 200,000 DA</option>
                <option value="200000-500000">Over 200,000 DA</option>
              </select>
            </div>
          </div>
          <div className="col-span-1">
